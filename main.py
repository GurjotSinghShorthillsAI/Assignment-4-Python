...
def main():
    ...
    pdf_loader = PDFLoader()   # Create an instance of PDFLoader to handle PDF files.
    docx_loader = DOCXLoader() # Create an instance of DOCXLoader to handle DOCX files.
    ppt_loader = PPTLoader()   # Create an instance of PPTLoader to handle PPTX files.

    # Set the file paths for each loader to specify which files they will process.
    pdf_loader.filepath = "test_files/pdf/large.pdf"   # Path to the PDF file to be processed.
    docx_loader.filepath = "test_files/docx/large.docx" # Path to the DOCX file to be processed.
    ppt_loader.filepath = "test_files/pptx/large.pptx" # Path to the PPTX file to be processed.
